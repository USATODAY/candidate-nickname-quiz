...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    ftp: {
      ...
      upload1: {
        files: {
          '/17200/experiments/usatoday/2015/09/candidate-nickname-match-game/': 'js/main.js'
        }
      },
      upload2: {
        files: {
          '/17200/experiments/usatoday/2015/09/candidate-nickname-match-game/': 'style/project.css'
        }
      },
      upload3: {
        files: {
          '/17200/experiments/usatoday/2015/09/candidate-nickname-match-game/': 'data/*.json'
        }
      }
    },
