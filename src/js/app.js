define(
  ...
  function(jQuery, _, templates, Analytics, config) {
    ...
    var base_path = "http://www.gannett-cdn.com/experiments/usatoday/2015/09/candidate-nickname-match-game/";

    var shareText = "Match presidential candidates to their fantasy code names. How well do you know the Republican field? ";

    var copy = [
        {
            "head": "CANDIDATE QUIZ",
            "round": "1",
            "chatter": "Republican candidates were asked Wednesday night to name their dream Secret Service code names. University of Florida grad Sen. Marco Rubio chose Gator while Gov. Scott Walker selected Harley — his motorcycle of choice. Can you guess what these other candidates said?"
        }
    ];
    ...
    matchGameObj.gameCompleted = function(timeUnits) {
      ...
      var endShareText = "I matched presidential candidates to their fantasy code names in " + totalAttempts + " tries. How well do you know the Republican field?";
    ...
    matchGameObj.init = function() {
        ...
        if ((hostname == "localhost" || hostname == "10.0.2.2")) {
            ...
            dataURL = "http://" + hostname + "/services/webproxy/?url=http://www.gannett-cdn.com/experiments/usatoday/2015/09/candidate-nickname-match-game/data/data.json";
        }
